...
\setDAParameter{Student}{Karl-Ludwig Besser, Zhongju Li, Franz Marcus Sch\"uffny, Peter Steiner}
...
Nach anf\"anglichen mechanischen Maschinen wie in Abbildung \ref*{fig:von-kempelen} gab es dank der Entwicklung elektronischer Filter sowie des Einsatzes moderner Computertechnik neue Meilensteine im Bereich der Sprachsynthese. 
...
Das Anregungssignal f\"ur die stimmhaften Laute soll den glottalen Luftstrom nachbilden. Dazu wurde eine von Paul Taylor vorgeschlagene Formel benutzt. \cite[S. 331]{TaylorTTS}
...
Das Spektrum des Anregungssignals ist in Abbildung \ref{fig:sourcesignal} abgebildet.
...
Zur Synthese von Zischlauten wird ein Rauschgenerator als Quelle verwendet. Die Signalformung wird nach Klatt mittels Bandpassfilter in Parallelschaltung realisiert. \cite{klatt1980software} %Eine Filterstruktur nach Abbildung \ref{fig:qfm-zisch} wird zur Synthese von Zischlauten verwendet.
